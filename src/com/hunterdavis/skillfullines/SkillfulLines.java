...
public class SkillfulLines extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button ssButton = (Button) findViewById(R.id.screenshotButton);
		ssButton.setOnClickListener(screenshotButtonListner);

		Toast.makeText(getBaseContext(), "Touch To Place Dots and Score",
